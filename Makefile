...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2016/11/26 16:26:54 by sprotsen          #+#    #+#              #
#    Updated: 2016/11/26 19:31:00 by sprotsen         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC = ft_memset.c ft_bzero.c ft_memcpy.c ft_memccpy.c ft_memmove.c \
		...
		ft_strncpy.c ft_strcat.c ft_strncat.c ft_strlcat.c ft_strlcat.c \
		...
		ft_lstaddend.c ft_lstsize.c ft_sortmass.c ft_atoi_ulli.c \
		get_next_line.c ft_lstdel_recursive.c ft_strdel_char_mass.c
